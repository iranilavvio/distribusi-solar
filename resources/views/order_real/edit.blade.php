                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-alternative mb-4">
                                    ...
                                    <input
                                        ...
                                        id="receive_po_edit" onkeyup="calc()">
                                </div>
                                @error('receive_po')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-alternative mb-4">
                                    ...
                                    <input
                                        ...
                                        id="realisasi_edit" onkeyup="calc()">
                                </div>
                                @error('realisasi')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
...
@push('js')
    <script>
        ...
        function calc() {
            var receive = document.getElementById('receive_po_edit').value;
            var real = document.getElementById('realisasi_edit').value;
            var result = (parseFloat(receive) - parseFloat(real));
            if (!isNaN(result)) {
                document.getElementById('unreal_edit').value = result;
            }
        }
    </script>
@endpush
