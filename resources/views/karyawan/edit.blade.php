<x-update-form :url="route('karyawan.update', $karyawan)">
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="input-group input-group-alternative mb-4">
                    ...
                    <input class="form-control form-control-alternative @error('name') is-invalid @enderror"
                        value="{{ old('name', @$karyawan->name) }}" placeholder="Masukkan Nama Karyawan"
            ...
            <div class="form-group">
                ...
                <div class="input-group input-group-alternative mb-4">
                    ...
                    <input class="form-control form-control-alternative @error('nik') is-invalid @enderror"
                        value="{{ old('nik', @$karyawan->nik) }}" placeholder="Masukkan NIK" type="number"
                        name="nik" id="nik">
                </div>
                @error('nik')
                    <div class="alert alert-danger">{{ $message }}</div>
            ...
            <div class="form-group">
                ...
                <div class="input-group input-group-alternative mb-4">
                    ...
                    <input class="form-control form-control-alternative @error('alamat') is-invalid @enderror"
                        value="{{ old('alamat', @$karyawan->alamat) }}" placeholder="Masukkan Alamat" type="text"
            ...
            <div class="form-group">
                ...
                <div class="input-group input-group-alternative mb-4">
                    ...
                    <input class="form-control form-control-alternative @error('no_telp') is-invalid @enderror"
                        value="{{ old('no_telp', @$karyawan->no_telp) }}" placeholder="Masukkan Nomor Telpon"
